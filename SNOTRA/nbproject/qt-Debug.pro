...
PKGCONFIG +=
QT = core gui sql
SOURCES += modele/Device.cpp modele/ARPTable.cpp modele/DeviceN4.cpp ToolBox.cpp modele/ICMPHeader.cpp modele/NetworkInterface.cpp DataBaseManager.cpp modele/Frame.cpp modele/NetworkHeader.cpp modele/Wire.cpp main.cpp modele/Hub.cpp modele/Header.cpp WireShark.cpp modele/Mac.cpp modele/ARPHeader.cpp modele/TransportHeader.cpp modele/Switch.cpp modele/UDPHeader.cpp RelevantActions.cpp modele/DataLinkHeader.cpp modele/Ipv4.cpp Game.cpp modele/RoutingTable.cpp NetworkGameArea.cpp modele/MacTable.cpp Confirmation.cpp modele/Ip.cpp PortConnecterChoice.cpp modele/TCPHeader.cpp Charger.cpp modele/Mask.cpp Sauvegarder.cpp
